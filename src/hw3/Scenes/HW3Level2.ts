...
export default class Level2 extends HW3Level {
    ...
    public static readonly PLAYER_SPRITE_PATH = "hw4_assets/spritesheets/Platypus.json";
    ...
    public static readonly LEVEL_MUSIC_PATH = "hw4_assets/music/hw3_level2_music.wav";
